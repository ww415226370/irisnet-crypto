  ...
  irisnet.tx = function () {
    ...
    tx.Coin = function () {
      ...
      function Coin(properties) {
        if (properties) for (var keys = (0, _keys["default"])(properties), i = 0; i < keys.length; ++i) {
      ...
      Coin.encode = function encode(message, writer) {
        ...
        writer.uint32(
        /* id 1, wireType 2 =*/
        10).string(message.denom);
        writer.uint32(
        /* id 2, wireType 2 =*/
        18).string(message.amount);
        return writer;
      };
      /**
      ...
      Coin.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("denom")) throw $util.ProtocolError("missing required 'denom'", {
          instance: message
        });
    ...
    tx.Input = function () {
      ...
      Input.encode = function encode(message, writer) {
        ...
        if (message.coins != null && message.coins.length) for (var i = 0; i < message.coins.length; ++i) {
          $root.irisnet.tx.Coin.encode(message.coins[i], writer.uint32(
          /* id 2, wireType 2 =*/
          18).fork()).ldelim();
        }
        return writer;
      ...
      Input.verify = function verify(message) {
        ...
        if (message.coins != null && message.hasOwnProperty("coins")) {
          if (!(0, _isArray["default"])(message.coins)) return "coins: array expected";
      ...
      Input.fromObject = function fromObject(object) {
        ...
        if (object.coins) {
          if (!(0, _isArray["default"])(object.coins)) throw TypeError(".irisnet.tx.Input.coins: array expected");
          message.coins = [];

          for (var i = 0; i < object.coins.length; ++i) {
            if ((0, _typeof2["default"])(object.coins[i]) !== "object") throw TypeError(".irisnet.tx.Input.coins: object expected");
      ...
      Input.toObject = function toObject(message, options) {
        ...
        if (options.defaults) if (options.bytes === String) object.address = "";else {
          object.address = [];
    ...
    tx.Output = function () {
      ...
      Output.fromObject = function fromObject(object) {
        ...
        if (object.coins) {
          if (!(0, _isArray["default"])(object.coins)) throw TypeError(".irisnet.tx.Output.coins: array expected");
          message.coins = [];

          for (var i = 0; i < object.coins.length; ++i) {
            if ((0, _typeof2["default"])(object.coins[i]) !== "object") throw TypeError(".irisnet.tx.Output.coins: object expected");
            message.coins[i] = $root.irisnet.tx.Coin.fromObject(object.coins[i]);
          }
        }
    ...
    tx.MsgSend = function () {
      ...
      MsgSend.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.input != null && message.input.length) for (var i = 0; i < message.input.length; ++i) {
          $root.irisnet.tx.Input.encode(message.input[i], writer.uint32(
          /* id 1, wireType 2 =*/
          10).fork()).ldelim();
        }
        if (message.output != null && message.output.length) for (var i = 0; i < message.output.length; ++i) {
          $root.irisnet.tx.Output.encode(message.output[i], writer.uint32(
          /* id 2, wireType 2 =*/
          18).fork()).ldelim();
        }
        return writer;
      ...
      MsgSend.verify = function verify(message) {
        ...
        if (message.input != null && message.hasOwnProperty("input")) {
          if (!(0, _isArray["default"])(message.input)) return "input: array expected";
        ...
        if (message.output != null && message.hasOwnProperty("output")) {
          if (!(0, _isArray["default"])(message.output)) return "output: array expected";
      ...
      MsgSend.fromObject = function fromObject(object) {
        ...
        if (object.input) {
          if (!(0, _isArray["default"])(object.input)) throw TypeError(".irisnet.tx.MsgSend.input: array expected");
          message.input = [];

          for (var i = 0; i < object.input.length; ++i) {
            if ((0, _typeof2["default"])(object.input[i]) !== "object") throw TypeError(".irisnet.tx.MsgSend.input: object expected");
            message.input[i] = $root.irisnet.tx.Input.fromObject(object.input[i]);
          }
        }

        if (object.output) {
          if (!(0, _isArray["default"])(object.output)) throw TypeError(".irisnet.tx.MsgSend.output: array expected");
          message.output = [];

          for (var i = 0; i < object.output.length; ++i) {
            if ((0, _typeof2["default"])(object.output[i]) !== "object") throw TypeError(".irisnet.tx.MsgSend.output: object expected");
    ...
    tx.MsgDelegate = function () {
      ...
      MsgDelegate.encode = function encode(message, writer) {
        ...
        writer.uint32(
        /* id 1, wireType 2 =*/
        10).bytes(message.delegatorAddr);
        writer.uint32(
        /* id 2, wireType 2 =*/
        18).bytes(message.validatorAddr);
        $root.irisnet.tx.Coin.encode(message.delegation, writer.uint32(
        /* id 3, wireType 2 =*/
        26).fork()).ldelim();
        return writer;
      };
      ...
      MsgDelegate.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("delegatorAddr")) throw $util.ProtocolError("missing required 'delegatorAddr'", {
          instance: message
        });
        if (!message.hasOwnProperty("validatorAddr")) throw $util.ProtocolError("missing required 'validatorAddr'", {
          instance: message
        });
        if (!message.hasOwnProperty("delegation")) throw $util.ProtocolError("missing required 'delegation'", {
          instance: message
        });
        return message;
      };
      ...
      MsgDelegate.fromObject = function fromObject(object) {
        ...
        if (object.delegatorAddr != null) if (typeof object.delegatorAddr === "string") $util.base64.decode(object.delegatorAddr, message.delegatorAddr = $util.newBuffer($util.base64.length(object.delegatorAddr)), 0);else if (object.delegatorAddr.length) message.delegatorAddr = object.delegatorAddr;
        if (object.validatorAddr != null) if (typeof object.validatorAddr === "string") $util.base64.decode(object.validatorAddr, message.validatorAddr = $util.newBuffer($util.base64.length(object.validatorAddr)), 0);else if (object.validatorAddr.length) message.validatorAddr = object.validatorAddr;

        if (object.delegation != null) {
          if ((0, _typeof2["default"])(object.delegation) !== "object") throw TypeError(".irisnet.tx.MsgDelegate.delegation: object expected");
    ...
    tx.MsgBeginUnbonding = function () {
      ...
      MsgBeginUnbonding.encode = function encode(message, writer) {
        ...
        /* id 2, wireType 2 =*/
        18).bytes(message.validatorAddr);
        var shares = message.sharesAmount.replace(".", ""); //fuck
      ...
      MsgBeginUnbonding.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("sharesAmount")) throw $util.ProtocolError("missing required 'sharesAmount'", {
          instance: message
        });
        return message;
      };
    ...
    tx.MsgBeginRedelegate = function () {
      ...
      MsgBeginRedelegate.encode = function encode(message, writer) {
        ...
        writer.uint32(
        /* id 2, wireType 2 =*/
        18).bytes(message.validatorSrcAddr);
        writer.uint32(
        /* id 3, wireType 2 =*/
        26).bytes(message.validatorDstAddr);
        var shares = message.sharesAmount.replace(".", ""); //fuck
      ...
      MsgBeginRedelegate.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("validatorSrcAddr")) throw $util.ProtocolError("missing required 'validatorSrcAddr'", {
          instance: message
        });
        if (!message.hasOwnProperty("validatorDstAddr")) throw $util.ProtocolError("missing required 'validatorDstAddr'", {
          instance: message
        });
        if (!message.hasOwnProperty("sharesAmount")) throw $util.ProtocolError("missing required 'sharesAmount'", {
          instance: message
      ...
      MsgBeginRedelegate.fromObject = function fromObject(object) {
        ...
        if (object.delegatorAddr != null) if (typeof object.delegatorAddr === "string") $util.base64.decode(object.delegatorAddr, message.delegatorAddr = $util.newBuffer($util.base64.length(object.delegatorAddr)), 0);else if (object.delegatorAddr.length) message.delegatorAddr = object.delegatorAddr;
        if (object.validatorSrcAddr != null) if (typeof object.validatorSrcAddr === "string") $util.base64.decode(object.validatorSrcAddr, message.validatorSrcAddr = $util.newBuffer($util.base64.length(object.validatorSrcAddr)), 0);else if (object.validatorSrcAddr.length) message.validatorSrcAddr = object.validatorSrcAddr;
        if (object.validatorDstAddr != null) if (typeof object.validatorDstAddr === "string") $util.base64.decode(object.validatorDstAddr, message.validatorDstAddr = $util.newBuffer($util.base64.length(object.validatorDstAddr)), 0);else if (object.validatorDstAddr.length) message.validatorDstAddr = object.validatorDstAddr;
        if (object.sharesAmount != null) message.sharesAmount = String(object.sharesAmount);
        return message;
      };
      /**
    ...
    tx.MsgWithdrawDelegatorRewardsAll = function () {
      ...
      MsgWithdrawDelegatorRewardsAll.toObject = function toObject(message, options) {
        if (!options) options = {};
        var object = {};
        if (options.defaults) if (options.bytes === String) object.delegatorAddr = "";else {
          object.delegatorAddr = [];
          if (options.bytes !== Array) object.delegatorAddr = $util.newBuffer(object.delegatorAddr);
        }
        if (message.delegatorAddr != null && message.hasOwnProperty("delegatorAddr")) object.delegatorAddr = options.bytes === String ? $util.base64.encode(message.delegatorAddr, 0, message.delegatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.delegatorAddr) : message.delegatorAddr;
    ...
    tx.StdFee = function () {
      ...
      StdFee.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.amount != null && message.amount.length) for (var i = 0; i < message.amount.length; ++i) {
          $root.irisnet.tx.Coin.encode(message.amount[i], writer.uint32(
          /* id 1, wireType 2 =*/
          10).fork()).ldelim();
        }
        writer.uint32(
        /* id 2, wireType 0 =*/
        16).int64(message.gas);
        return writer;
      };
      /**
      ...
      StdFee.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("gas")) throw $util.ProtocolError("missing required 'gas'", {
          instance: message
        });
        return message;
      };
      ...
      StdFee.verify = function verify(message) {
        ...
        if (message.amount != null && message.hasOwnProperty("amount")) {
          if (!(0, _isArray["default"])(message.amount)) return "amount: array expected";
      ...
      StdFee.fromObject = function fromObject(object) {
        ...
        if (object.amount) {
          if (!(0, _isArray["default"])(object.amount)) throw TypeError(".irisnet.tx.StdFee.amount: array expected");
          message.amount = [];

          for (var i = 0; i < object.amount.length; ++i) {
            if ((0, _typeof2["default"])(object.amount[i]) !== "object") throw TypeError(".irisnet.tx.StdFee.amount: object expected");
            message.amount[i] = $root.irisnet.tx.Coin.fromObject(object.amount[i]);
          }
        }

        if (object.gas != null) if ($util.Long) (message.gas = $util.Long.fromValue(object.gas)).unsigned = false;else if (typeof object.gas === "string") message.gas = (0, _parseInt2["default"])(object.gas, 10);else if (typeof object.gas === "number") message.gas = object.gas;else if ((0, _typeof2["default"])(object.gas) === "object") message.gas = new $util.LongBits(object.gas.low >>> 0, object.gas.high >>> 0).toNumber();
        return message;
      };
      /**
      ...
      StdFee.toObject = function toObject(message, options) {
        ...
        if (options.defaults) if ($util.Long) {
          ...
          object.gas = options.longs === String ? _long.toString() : options.longs === Number ? _long.toNumber() : _long;
    ...
    tx.StdSignature = function () {
      ...
      StdSignature.encode = function encode(message, writer) {
        ...
        writer.uint32(
        /* id 1, wireType 2 =*/
        10).bytes(message.pubKey);
        writer.uint32(
        /* id 2, wireType 2 =*/
        18).bytes(message.signature); // ===========================整形过滤掉零值================================

        if (message.accountNumber !== 0) {
          writer.uint32(
          /* id 3, wireType 0 =*/
          24).int64(message.accountNumber);
        } // ===========================整形过滤掉零值================================
      ...
      StdSignature.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("pubKey")) throw $util.ProtocolError("missing required 'pubKey'", {
          instance: message
        });
        if (!message.hasOwnProperty("signature")) throw $util.ProtocolError("missing required 'signature'", {
          instance: message
        });
        if (!message.hasOwnProperty("accountNumber")) throw $util.ProtocolError("missing required 'accountNumber'", {
          instance: message
        });
      ...
      StdSignature.fromObject = function fromObject(object) {
        ...
        if (object.accountNumber != null) if ($util.Long) (message.accountNumber = $util.Long.fromValue(object.accountNumber)).unsigned = false;else if (typeof object.accountNumber === "string") message.accountNumber = (0, _parseInt2["default"])(object.accountNumber, 10);else if (typeof object.accountNumber === "number") message.accountNumber = object.accountNumber;else if ((0, _typeof2["default"])(object.accountNumber) === "object") message.accountNumber = new $util.LongBits(object.accountNumber.low >>> 0, object.accountNumber.high >>> 0).toNumber();
        if (object.sequence != null) if ($util.Long) (message.sequence = $util.Long.fromValue(object.sequence)).unsigned = false;else if (typeof object.sequence === "string") message.sequence = (0, _parseInt2["default"])(object.sequence, 10);else if (typeof object.sequence === "number") message.sequence = object.sequence;else if ((0, _typeof2["default"])(object.sequence) === "object") message.sequence = new $util.LongBits(object.sequence.low >>> 0, object.sequence.high >>> 0).toNumber();
        return message;
      };
      /**
      ...
      StdSignature.toObject = function toObject(message, options) {
        ...
        if (options.defaults) {
          ...
          if ($util.Long) {
            ...
            object.accountNumber = options.longs === String ? _long2.toString() : options.longs === Number ? _long2.toNumber() : _long2;
          } else object.accountNumber = options.longs === String ? "0" : 0;

          if ($util.Long) {
            var _long2 = new $util.Long(0, 0, false);

            object.sequence = options.longs === String ? _long2.toString() : options.longs === Number ? _long2.toNumber() : _long2;
        ...
        if (message.accountNumber != null && message.hasOwnProperty("accountNumber")) if (typeof message.accountNumber === "number") object.accountNumber = options.longs === String ? String(message.accountNumber) : message.accountNumber;else object.accountNumber = options.longs === String ? $util.Long.prototype.toString.call(message.accountNumber) : options.longs === Number ? new $util.LongBits(message.accountNumber.low >>> 0, message.accountNumber.high >>> 0).toNumber() : message.accountNumber;
        if (message.sequence != null && message.hasOwnProperty("sequence")) if (typeof message.sequence === "number") object.sequence = options.longs === String ? String(message.sequence) : message.sequence;else object.sequence = options.longs === String ? $util.Long.prototype.toString.call(message.sequence) : options.longs === Number ? new $util.LongBits(message.sequence.low >>> 0, message.sequence.high >>> 0).toNumber() : message.sequence;
        return object;
      };
      /**
    ...
    tx.StdTx = function () {
      ...
      StdTx.encode = function encode(message, writer) {
        if (!writer) writer = $Writer.create();
        if (message.msgs != null && message.msgs.length) for (var i = 0; i < message.msgs.length; ++i) {
          writer.uint32(
          /* id 1, wireType 2 =*/
          10).bytes(message.msgs[i]);
        }
        $root.irisnet.tx.StdFee.encode(message.fee, writer.uint32(
        /* id 2, wireType 2 =*/
        18).fork()).ldelim();
        if (message.signatures != null && message.signatures.length) for (var i = 0; i < message.signatures.length; ++i) {
          $root.irisnet.tx.StdSignature.encode(message.signatures[i], writer.uint32(
          /* id 3, wireType 2 =*/
          26).fork()).ldelim();
        }
        if (message.memo != null && message.hasOwnProperty("memo") && message.memo !== "") writer.uint32(
        /* id 4, wireType 2 =*/
        34).string(message.memo);
        return writer;
      };
      /**
      ...
      StdTx.decode = function decode(reader, length) {
        ...
        if (!message.hasOwnProperty("fee")) throw $util.ProtocolError("missing required 'fee'", {
          instance: message
        });
        return message;
      };
      ...
      StdTx.verify = function verify(message) {
        ...
        if (message.msgs != null && message.hasOwnProperty("msgs")) {
          if (!(0, _isArray["default"])(message.msgs)) return "msgs: array expected";

          for (var i = 0; i < message.msgs.length; ++i) {
            if (!(message.msgs[i] && typeof message.msgs[i].length === "number" || $util.isString(message.msgs[i]))) return "msgs: buffer[] expected";
          }
        }
        ...
        if (message.signatures != null && message.hasOwnProperty("signatures")) {
          if (!(0, _isArray["default"])(message.signatures)) return "signatures: array expected";
      ...
      StdTx.fromObject = function fromObject(object) {
        ...
        if (object.msgs) {
          if (!(0, _isArray["default"])(object.msgs)) throw TypeError(".irisnet.tx.StdTx.msgs: array expected");
          message.msgs = [];

          for (var i = 0; i < object.msgs.length; ++i) {
            if (typeof object.msgs[i] === "string") $util.base64.decode(object.msgs[i], message.msgs[i] = $util.newBuffer($util.base64.length(object.msgs[i])), 0);else if (object.msgs[i].length) message.msgs[i] = object.msgs[i];
          }
        }

        if (object.fee != null) {
          if ((0, _typeof2["default"])(object.fee) !== "object") throw TypeError(".irisnet.tx.StdTx.fee: object expected");
          message.fee = $root.irisnet.tx.StdFee.fromObject(object.fee);
        }

        if (object.signatures) {
          if (!(0, _isArray["default"])(object.signatures)) throw TypeError(".irisnet.tx.StdTx.signatures: array expected");
          message.signatures = [];

          for (var i = 0; i < object.signatures.length; ++i) {
            if ((0, _typeof2["default"])(object.signatures[i]) !== "object") throw TypeError(".irisnet.tx.StdTx.signatures: object expected");
