...
function () {
  ...
  (0, _createClass2["default"])(CosmosKeypair, null, [{
    ...
    value: function getPrivateKeyFromSecret(mnemonicS) {
      ...
      var derivedPriv = Hd.DerivePrivateKeyForPath(master.secret, master.chainCode, Config.cosmos.bip39Path);
      return derivedPriv;
    }
  }, {
    key: "sign",
    ...
    value: function create(language) {
      ...
      var pubKey = Secp256k1.publicKeyCreate(secretKey);
    ...
    value: function isValidAddress(address) {
      var prefix = Config.cosmos.bech32.accAddr;
  ...
  (0, _createClass2["default"])(Hd, null, [{
    ...
    value: function DerivePrivateKey(privKeyBytes, chainCode, index, harden) {
      ...
      if (harden) {
        ...
        var pubKey = Secp256k1.publicKeyCreate(privKeyBytes);
