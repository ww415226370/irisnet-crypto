...
$root.cosmos = function () {
  ...
  cosmos.MsgSend = function () {
    ...
    MsgSend.encode = function encode(message, writer) {
      ...
      writer.uint32(
      /* id 1, wireType 2 =*/
      10).bytes(message.FromAddress);
      writer.uint32(
      /* id 2, wireType 2 =*/
      18).bytes(message.ToAddress);
      if (message.Amount != null && message.Amount.length) for (var i = 0; i < message.Amount.length; ++i) {
        $root.cosmos.Coin.encode(message.Amount[i], writer.uint32(
        /* id 3, wireType 2 =*/
        26).fork()).ldelim();
      }
      return writer;
    ...
    MsgSend.decode = function decode(reader, length) {
      ...
      if (!message.hasOwnProperty("FromAddress")) throw $util.ProtocolError("missing required 'FromAddress'", {
        instance: message
      });
      if (!message.hasOwnProperty("ToAddress")) throw $util.ProtocolError("missing required 'ToAddress'", {
        instance: message
      });
      return message;
    };
    ...
    MsgSend.fromObject = function fromObject(object) {
      ...
      if (object.FromAddress != null) if (typeof object.FromAddress === "string") $util.base64.decode(object.FromAddress, message.FromAddress = $util.newBuffer($util.base64.length(object.FromAddress)), 0);else if (object.FromAddress.length) message.FromAddress = object.FromAddress;
      if (object.ToAddress != null) if (typeof object.ToAddress === "string") $util.base64.decode(object.ToAddress, message.ToAddress = $util.newBuffer($util.base64.length(object.ToAddress)), 0);else if (object.ToAddress.length) message.ToAddress = object.ToAddress;

      if (object.Amount) {
        if (!(0, _isArray["default"])(object.Amount)) throw TypeError(".cosmos.MsgSend.Amount: array expected");
        message.Amount = [];

        for (var i = 0; i < object.Amount.length; ++i) {
          if ((0, _typeof2["default"])(object.Amount[i]) !== "object") throw TypeError(".cosmos.MsgSend.Amount: object expected");
  ...
  cosmos.MsgDelegate = function () {
    ...
    MsgDelegate.encode = function encode(message, writer) {
      ...
      $root.cosmos.Coin.encode(message.Value, writer.uint32(
      /* id 3, wireType 2 =*/
      26).fork()).ldelim();
      return writer;
    };
    ...
    MsgDelegate.fromObject = function fromObject(object) {
      ...
      if (object.Value != null) {
        if ((0, _typeof2["default"])(object.Value) !== "object") throw TypeError(".cosmos.MsgDelegate.Value: object expected");
    ...
    MsgDelegate.toObject = function toObject(message, options) {
      ...
      if (message.Value != null && message.hasOwnProperty("Value")) object.Value = $root.cosmos.Coin.toObject(message.Value, options);
      return object;
    };
    /**
  ...
  cosmos.MsgUndelegate = function () {
    ...
    MsgUndelegate.encode = function encode(message, writer) {
      ...
      /* id 2, wireType 2 =*/
      18).bytes(message.ValidatorAddr);
      var shares = message.SharesAmount.replace(".", "");
  ...
  cosmos.MsgSetWithdrawAddress = function () {
    ...
    MsgSetWithdrawAddress.decode = function decode(reader, length) {
      ...
      if (!message.hasOwnProperty("WithdrawAddr")) throw $util.ProtocolError("missing required 'WithdrawAddr'", {
        instance: message
      });
      return message;
    };
    ...
    MsgSetWithdrawAddress.verify = function verify(message) {
      if ((0, _typeof2["default"])(message) !== "object" || message === null) return "object expected";
      if (!(message.DelegatorAddr && typeof message.DelegatorAddr.length === "number" || $util.isString(message.DelegatorAddr))) return "DelegatorAddr: buffer expected";
      if (!(message.WithdrawAddr && typeof message.WithdrawAddr.length === "number" || $util.isString(message.WithdrawAddr))) return "WithdrawAddr: buffer expected";
      return null;
    };
    /**
    ...
    MsgSetWithdrawAddress.fromObject = function fromObject(object) {
      ...
      if (object.DelegatorAddr != null) if (typeof object.DelegatorAddr === "string") $util.base64.decode(object.DelegatorAddr, message.DelegatorAddr = $util.newBuffer($util.base64.length(object.DelegatorAddr)), 0);else if (object.DelegatorAddr.length) message.DelegatorAddr = object.DelegatorAddr;
      if (object.WithdrawAddr != null) if (typeof object.WithdrawAddr === "string") $util.base64.decode(object.WithdrawAddr, message.WithdrawAddr = $util.newBuffer($util.base64.length(object.WithdrawAddr)), 0);else if (object.WithdrawAddr.length) message.WithdrawAddr = object.WithdrawAddr;
      return message;
    };
    /**
    ...
    MsgSetWithdrawAddress.toObject = function toObject(message, options) {
      ...
      if (options.defaults) {
        ...
        if (options.bytes === String) object.WithdrawAddr = "";else {
          object.WithdrawAddr = [];
      ...
      if (message.DelegatorAddr != null && message.hasOwnProperty("DelegatorAddr")) object.DelegatorAddr = options.bytes === String ? $util.base64.encode(message.DelegatorAddr, 0, message.DelegatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.DelegatorAddr) : message.DelegatorAddr;
      if (message.WithdrawAddr != null && message.hasOwnProperty("WithdrawAddr")) object.WithdrawAddr = options.bytes === String ? $util.base64.encode(message.WithdrawAddr, 0, message.WithdrawAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.WithdrawAddr) : message.WithdrawAddr;
      return object;
    };
    /**
  ...
  cosmos.MsgWithdrawValidatorCommission = function () {
    ...
    MsgWithdrawValidatorCommission.encode = function encode(message, writer) {
      ...
      writer.uint32(
      /* id 1, wireType 2 =*/
      10).bytes(message.ValidatorAddr);
      return writer;
    };
    /**
    ...
    MsgWithdrawValidatorCommission.toObject = function toObject(message, options) {
      if (!options) options = {};
      var object = {};
      if (options.defaults) if (options.bytes === String) object.ValidatorAddr = "";else {
        object.ValidatorAddr = [];
        if (options.bytes !== Array) object.ValidatorAddr = $util.newBuffer(object.ValidatorAddr);
      }
      if (message.ValidatorAddr != null && message.hasOwnProperty("ValidatorAddr")) object.ValidatorAddr = options.bytes === String ? $util.base64.encode(message.ValidatorAddr, 0, message.ValidatorAddr.length) : options.bytes === Array ? Array.prototype.slice.call(message.ValidatorAddr) : message.ValidatorAddr;
  ...
  cosmos.StdFee = function () {
    ...
    StdFee.fromObject = function fromObject(object) {
      ...
      if (object.amount) {
        if (!(0, _isArray["default"])(object.amount)) throw TypeError(".cosmos.StdFee.amount: array expected");
        message.amount = [];

        for (var i = 0; i < object.amount.length; ++i) {
          if ((0, _typeof2["default"])(object.amount[i]) !== "object") throw TypeError(".cosmos.StdFee.amount: object expected");
          message.amount[i] = $root.cosmos.Coin.fromObject(object.amount[i]);
        }
      }
  ...
  cosmos.StdTx = function () {
    ...
    StdTx.encode = function encode(message, writer) {
      if (!writer) writer = $Writer.create();
      if (message.msg != null && message.msg.length) for (var i = 0; i < message.msg.length; ++i) {
        writer.uint32(
        /* id 1, wireType 2 =*/
        10).bytes(message.msg[i]);
      }
      $root.cosmos.StdFee.encode(message.fee, writer.uint32(
      /* id 2, wireType 2 =*/
      18).fork()).ldelim();
      if (message.signatures != null && message.signatures.length) for (var i = 0; i < message.signatures.length; ++i) {
        $root.cosmos.StdSignature.encode(message.signatures[i], writer.uint32(
        /* id 3, wireType 2 =*/
        26).fork()).ldelim();
      }
    ...
    StdTx.verify = function verify(message) {
      ...
      if (message.msg != null && message.hasOwnProperty("msg")) {
        if (!(0, _isArray["default"])(message.msg)) return "msg: array expected";

        for (var i = 0; i < message.msg.length; ++i) {
          if (!(message.msg[i] && typeof message.msg[i].length === "number" || $util.isString(message.msg[i]))) return "msg: buffer[] expected";
        }
      }
    ...
    StdTx.fromObject = function fromObject(object) {
      ...
      if (object.msg) {
        if (!(0, _isArray["default"])(object.msg)) throw TypeError(".cosmos.StdTx.msg: array expected");
        message.msg = [];

        for (var i = 0; i < object.msg.length; ++i) {
          if (typeof object.msg[i] === "string") $util.base64.decode(object.msg[i], message.msg[i] = $util.newBuffer($util.base64.length(object.msg[i])), 0);else if (object.msg[i].length) message.msg[i] = object.msg[i];
        }
      }

      if (object.fee != null) {
        if ((0, _typeof2["default"])(object.fee) !== "object") throw TypeError(".cosmos.StdTx.fee: object expected");
        message.fee = $root.cosmos.StdFee.fromObject(object.fee);
      }

      if (object.signatures) {
        if (!(0, _isArray["default"])(object.signatures)) throw TypeError(".cosmos.StdTx.signatures: array expected");
        message.signatures = [];

        for (var i = 0; i < object.signatures.length; ++i) {
          if ((0, _typeof2["default"])(object.signatures[i]) !== "object") throw TypeError(".cosmos.StdTx.signatures: object expected");
